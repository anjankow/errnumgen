...
func (g *Generator) genOutputFile() (string, error) {
	...
	if g.outPkg == nil {
		...
		g.genNewOutputFile(&buf)
	} else {
		// Populate with the existing file content
		// and remove the closing bracket for the const block

	}

}

func (g *Generator) genNewOutputFile(buf *bytes.Buffer) {
	fmt.Fprintf(buf, "// Code generated by errnumgen. DO NOT EDIT.\n")
	fmt.Fprintf(buf, "package %s\n\n", g.opts.OutPackageName)
	fmt.Fprintf(buf, "type ErrNum int\n\n")
